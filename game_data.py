# HollywoodSim/game/game_data.py
...
# ==============================================================================
# 11. STUDIO FACILITIES (NEW)
# Defines different types of studio facilities the player can build.
# - cost: Initial construction cost (in millions).
# - monthly_upkeep: Ongoing maintenance cost (in millions).
# - capacity: Number of concurrent projects the facility can handle.
# ==============================================================================


STUDIO_FACILITIES = {
    "backlot": {"cost": 30.0, "monthly_upkeep": 1.0, "capacity": 2},
    "sound_stage": {"cost": 50.0, "monthly_upkeep": 1.5, "capacity": 1}
}
